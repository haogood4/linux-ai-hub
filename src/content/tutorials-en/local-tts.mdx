...
Following the ideas in [Function Calling & MCP](/tutorials/function-calling-mcp) (Chinese), let the LLM decide when to speak:
...
You can also use [Open WebUI](/tutorials/open-webui)'s TTS plugin (Chinese) to read replies aloud right in the chat UI.
...
- Give your model tools and a brain → [Function Calling & MCP](/tutorials/function-calling-mcp) (Chinese)
- Chat UI with voice integration → [Open WebUI](/tutorials/open-webui) (Chinese)
- Voice-over for videos (TTS + video generation) → [Local AI Video Generation](/en/tutorials/ai-video-generation)
- Isolate the TTS service with [Docker GPU Containers](/tutorials/docker-gpu-containers) (Chinese) for a clean, stable setup
